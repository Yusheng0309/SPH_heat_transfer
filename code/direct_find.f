...
c----------------------------------------------------------------------
c     Subroutine to calculate the smoothing funciton for each particle 
c     and the interaction parameters used by the SPH algorithm. 
c     Interaction pairs are determined by directly comparing the 
c     particle distance with the corresponding smoothing length.
